        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="index.php?page=create-doctor&action=add" class="btn btn-primary">New Doctor</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="index.php?page=delete-doctor&id=<?= $doctor->getId();?>&action=delete-doctor" class="text-danger w-4 h-4 mr-1">
