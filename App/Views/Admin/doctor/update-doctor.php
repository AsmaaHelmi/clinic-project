                           ...
                           <div class="row">
                               <div class="col-md-12">
                                   <div class="mb-3">
                                       ...
                                       <input type="text" name="name" id="name" class="form-control" value="<?= $row->getUserId(); ?>"
                                           placeholder="Name">
                                   </div>
                               </div>
                               ...
                               <div class="col-md-12">
                                   <div class="mb-3">
                                       ...
                                       <input type="email" name="email" id="email" class="form-control" value="<?= $row->getUserId(); ?>"
                                           placeholder="Email">
                                   </div>
                               </div>
                               ...
                               <div class="col-md-12">
                                   <div class="mb-3">
                                       ...
                                       <input type="tel" name="phone" id="phone" class="form-control" value="<?= $row->getPhone(); ?>"
                                           placeholder="Phone">
                                   </div>
                               </div>
