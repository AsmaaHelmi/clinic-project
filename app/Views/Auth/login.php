...
<div class="container">
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="fw-bold my-4 h4">
        <ol class="breadcrumb justify-content-center">
            <li class="breadcrumb-item">
                <a class="text-decoration-none" href="index.php?page=home">Home</a>
            </li>
    ...
    <div class="d-flex flex-column gap-3 account-form mx-auto mt-5" style="max-width: 500px;">
        ...
        <form class="form" method="POST" action="index.php?page=login">
            ...
            <div class="form-items">
                ...
                <div class="mb-3">
                    ...
                    <label class="form-label required-label" for="password">
                        Password
                    </label>
        ...
        <div class="d-flex justify-content-center gap-2">
            ...
            <a class="link" href="index.php?page=register">
                Create account
            </a>
